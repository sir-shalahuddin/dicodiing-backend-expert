...
DomainErrorTranslator._directories = {
  ...
  'ADD_COMMENT.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('tidak dapat membuat comment baru properti yang dibutuhkan tidak ada'),
  ...
  'ADD_REPLY.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('tidakdapat menambahkan balasan baru karena tipe data tidak sesuai'),
